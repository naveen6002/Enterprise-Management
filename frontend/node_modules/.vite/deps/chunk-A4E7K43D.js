...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(React3.Fragment, {
    children: yTicks.map(({
      value,
      offset
    }) => (0, import_jsx_runtime3.jsx)(GridLine, {
      y1: offset,
      y2: offset,
      x1: drawingArea.left,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime4.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime4.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime4.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
//# sourceMappingURL=chunk-A4E7K43D.js.map
