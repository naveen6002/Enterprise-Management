...
function locale_default(locale3) {
  ...
  function newFormat(specifier, options) {
    ...
    function format2(value) {
      ...
      if (type === "c") {
        ...
        valueSuffix = (type === "s" && !isNaN(value) && prefixExponent !== void 0 ? prefixes2[8 + prefixExponent / 3] : "") + valueSuffix + (valueNegative && sign2 === "(" ? ")" : "");
        if (maybeSuffix) {
          i = -1, n = value.length;
          while (++i < n) {
  ...
  function formatPrefix2(specifier, value) {
    var e = Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3, k2 = Math.pow(10, -e), f = newFormat((specifier = formatSpecifier(specifier), specifier.type = "f", specifier), { suffix: prefixes2[8 + e / 3] });
...
var InteractionContext = React21.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React21.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React21.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React23.createContext({
  isInitialized: false,
  data: {
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React24.useContext(HighlightedContext);
  if (!isInitialized) {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React25.useMemo(() => {
  ...
  const providerValue = React25.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
var AnimationContext = React31.createContext({
  isInitialized: false,
  data: {
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React32.useContext(AnimationContext);
  if (!isInitialized) {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React33.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime8.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime9.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime9.jsxs)(React34.Fragment, {
        children: [(0, import_jsx_runtime9.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime10.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime10.jsx)("stop", {
        offset,
        stopColor: color3,
        stopOpacity: 1
      }, keyPrefix + index2);
...
function useChartGradient() {
  ...
  return React36.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime11.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime11.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse2,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime11.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse2,
          scale,
          colorScale,
          colorMap,
...
var RtlContext = React44.createContext();
function RtlProvider({
  value,
  ...props
}) {
  return (0, import_jsx_runtime15.jsx)(RtlContext.Provider, {
    value: value ?? true,
    ...props
  });
}
...
var useRtl = () => {
  const value = React44.useContext(RtlContext);
  return value ?? false;
};
...
function ChartsText(props) {
  ...
  const wordsByLines = React45.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime16.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line, index2) => (0, import_jsx_runtime16.jsx)("tspan", {
      x: x2,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types7.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types7.default.bool,
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime17.jsxs)(XAxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime17.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime17.jsxs)("g", {
        ...
        children: [!disableTicks && showTick && (0, import_jsx_runtime17.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime17.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime18.jsxs)(YAxisRoot, {
    transform: `translate(${position2 === "right" ? left2 + width2 : left2}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime18.jsx)(Line, _extends({
      y1: top2,
      y2: top2 + height2,
      className: classes.line
      ...
      return (0, import_jsx_runtime18.jsxs)("g", {
        ...
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime18.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime18.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index2);
    }), label && (0, import_jsx_runtime18.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime18.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React49.Fragment, {
    children: [topId && (0, import_jsx_runtime19.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime19.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime19.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime19.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React50.useState(null);
  React50.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function StyledEngineProvider(props) {
  ...
  const cache = React51.useMemo(() => {
    const cacheKey2 = `${injectFirst}-${enableCssLayer}`;
    if (typeof document === "object" && cacheMap.has(cacheKey2)) {
      return cacheMap.get(cacheKey2);
    }
    const fresh = getCache(injectFirst, enableCssLayer);
    cacheMap.set(cacheKey2, fresh);
    return fresh;
...
function deepClone(source) {
  if (React52.isValidElement(source) || (0, import_react_is.isValidElementType)(source) || !isPlainObject(source)) {
    return source;
  }
  const output = {};
...
function deepmerge(target, source, options = {
  ...
  if (isPlainObject(target) && isPlainObject(source)) {
    Object.keys(source).forEach((key) => {
      if (React52.isValidElement(source[key]) || (0, import_react_is.isValidElementType)(source[key])) {
...
function useTheme2(defaultTheme4 = null) {
  const contextTheme = React53.useContext(ThemeContext);
...
function createBox(options = {}) {
  ...
  const Box2 = React54.forwardRef(function Box3(inProps, ref) {
...
function resolveProps(defaultProps3, props, mergeClassNameAndStyle = false) {
  const output = {
    ...props
  };
  for (const key in defaultProps3) {
    if (Object.prototype.hasOwnProperty.call(defaultProps3, key)) {
      ...
      if (propName === "components" || propName === "slots") {
        ...
        output.className = clsx_default(defaultProps3 == null ? void 0 : defaultProps3.className, props == null ? void 0 : props.className);
      } else if (propName === "style" && mergeClassNameAndStyle && props.style) {
        output.style = {
          ...defaultProps3 == null ? void 0 : defaultProps3.style,
...
var useEnhancedEffect = typeof window !== "undefined" ? React55.useLayoutEffect : React55.useEffect;
...
var useUtilityClasses3 = (ownerState, componentName) => {
  ...
  const Grid2 = React67.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime31.jsx)(GridRoot, {
      ...
      children: React67.Children.map(children, (child) => {
        var _a;
        if (React67.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime33.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime33.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime33.jsx)("tbody", {
        children: (0, import_jsx_runtime33.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime33.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime33.jsx)(ChartsTooltipMark, {
              color: color3,
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types27.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types27.default.shape({
    dataIndex: import_prop_types27.default.number,
    seriesId: import_prop_types27.default.oneOfType([import_prop_types27.default.number, import_prop_types27.default.string]).isRequired,
    type: import_prop_types27.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types27.default.object.isRequired,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime35.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime35.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime35.jsx)("thead", {
        children: (0, import_jsx_runtime35.jsx)(ChartsTooltipRow, {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime35.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime35.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime35.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime35.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime35.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types28.default.object.isRequired,
  /**
   * Data identifying the triggered axis.
   */
  axisData: import_prop_types28.default.shape({
    x: import_prop_types28.default.shape({
      index: import_prop_types28.default.number,
      value: import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number, import_prop_types28.default.string]).isRequired
    }),
    y: import_prop_types28.default.shape({
      index: import_prop_types28.default.number,
      value: import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number, import_prop_types28.default.string]).isRequired
    })
  }).isRequired,
   ...
   */
  axisValue: import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number, import_prop_types28.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  dataIndex: import_prop_types28.default.number,
  /**
   * The series linked to the triggered axis.
   */
  series: import_prop_types28.default.arrayOf(import_prop_types28.default.object).isRequired,
...
function ChartsAxisTooltipContent(props) {
  ...
  const {
    zAxisIds,
    zAxis
  } = React72.useContext(ZAxisContext);
  const series = useSeries();
  const colorProcessors = useColorProcessor();
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React72.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React72.useMemo(() => {
  ...
  return (0, import_jsx_runtime36.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  return (0, import_jsx_runtime37.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime37.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime37.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime37.jsx)(ChartsAxisTooltipContent, {
...
true ? ChartsTooltip.propTypes = {
   ...
   */
  axisContent: import_prop_types29.default.elementType,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  itemContent: import_prop_types29.default.elementType,
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default 'axis'
   */
  trigger: import_prop_types29.default.oneOf(["axis", "item", "none"])
} : void 0;
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime38.jsxs)("g", {
    ...
    }), (0, import_jsx_runtime38.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime38.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const theme = useTheme();
  const drawingArea = useDrawingArea();
  const labelStyle = React77.useMemo(
  ...
  const padding2 = React77.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React77.useCallback((label, inStyle = {}) => {
    const style4 = _objectWithoutPropertiesLoose(inStyle, _excluded9);
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React77.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React77.useMemo(() => {
  ...
  return (0, import_jsx_runtime39.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime39.jsx)(ChartsLegendRoot, {
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
   ...
   */
  direction: import_prop_types30.default.oneOf(["column", "row"]).isRequired,
  /**
   * @deprecated Use the `useDrawingArea` hook instead.
   */
  drawingArea: import_prop_types30.default.shape({
    bottom: import_prop_types30.default.number.isRequired,
    height: import_prop_types30.default.number.isRequired,
    left: import_prop_types30.default.number.isRequired,
    right: import_prop_types30.default.number.isRequired,
   ...
   * @default 10
   */
  itemGap: import_prop_types30.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types30.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types30.default.number,
  /**
   ...
   * @default 5
   */
  markGap: import_prop_types30.default.number,
  /**
   ...
   * @default 10
   */
  padding: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.shape({
   ...
   */
  position: import_prop_types30.default.shape({
    horizontal: import_prop_types30.default.oneOf(["left", "middle", "right"]).isRequired,
    vertical: import_prop_types30.default.oneOf(["bottom", "middle", "top"]).isRequired
  }).isRequired,
  series: import_prop_types30.default.object.isRequired,
  seriesToDisplay: import_prop_types30.default.arrayOf(import_prop_types30.default.shape({
    ...
    itemId: import_prop_types30.default.oneOfType([import_prop_types30.default.number, import_prop_types30.default.string]),
    label: import_prop_types30.default.string.isRequired,
    maxValue: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
    minValue: import_prop_types30.default.oneOfType([import_prop_types30.default.instanceOf(Date), import_prop_types30.default.number]),
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime41.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
true ? ChartsLegend.propTypes = {
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types31.default.oneOf(["column", "row"]),
  /**
   * Set to true to hide the legend.
   * @default false
   */
   ...
   * @default 10
   */
  itemGap: import_prop_types31.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types31.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types31.default.number,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types31.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   * @param {SeriesLegendItemContext} legendItem The legend item data.
   ...
   * @default 10
   */
  padding: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.shape({
   ...
   * The position of the legend.
   */
  position: import_prop_types31.default.shape({
    horizontal: import_prop_types31.default.oneOf(["left", "middle", "right"]).isRequired,
    vertical: import_prop_types31.default.oneOf(["bottom", "middle", "top"]).isRequired
  }),
  /**
   * The props used for each component slot.
   * @default {}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React80.useContext(ZAxisContext);
...
function ContinuousColorLegend(props) {
  ...
  return (0, import_jsx_runtime42.jsxs)(React81.Fragment, {
    children: [(0, import_jsx_runtime42.jsx)(ChartsContinuousGradient, {
      isReversed,
      gradientId: id,
      size,
    ...
    }), (0, import_jsx_runtime42.jsx)(ChartsText, {
      text: text1,
    ...
    }), (0, import_jsx_runtime42.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types32.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types32.default.oneOf(["x", "y", "z"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types32.default.oneOfType([import_prop_types32.default.number, import_prop_types32.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types32.default.oneOfType([import_prop_types32.default.func, import_prop_types32.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types32.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
   * The space between the gradient bar and the labels.
   * @default 4
   */
  spacing: import_prop_types32.default.number,
  /**
...
function PiecewiseColorLegend(props) {
  ...
  return (0, import_jsx_runtime43.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types33.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
  axisId: import_prop_types33.default.oneOfType([import_prop_types33.default.number, import_prop_types33.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   * @default false
   */
  hideFirst: import_prop_types33.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types33.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
   ...
   */
  labelFormatter: import_prop_types33.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
...
function ChartsAxisHighlight(props) {
  ...
  const {
    axis
  } = React83.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime44.jsxs)(React83.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime44.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime44.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime44.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime44.jsx)(ChartsAxisHighlightPath, {
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(StyledText, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime46.jsx)(StyledText2, _extends({
    x: left2 + width2 / 2,
    y: top2 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime47.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime47.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6M7J3N3Q.js.map
